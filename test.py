...
"Wisdom", "Courage", "Justice", "Temperance". Also analyze the emotions based on the content one of: "Joyful", "Excited", "Content", "Grateful", "Peaceful", "Bored", "Calm", "Curious", "Confused", "Lonely", "Disappointed", "Scared", "Frustrated", "Anxious", "Jealous", "Embarrassed", "Guilty".
   User: Here's the User's Journal entry for the day: 
    {journal_entry}
    Give me output in Pydantic format as below that I can parse it using pydantic parser:
    {format_instructions}
"""
load_dotenv()
...
# print(ollama.invoke('analyse this information: Sky is blue, but my heart is bluer.'))
...
async def analyze_entry(request: Request, journal_entry: str = Form(...)):
    ...
    try :
        ...
        pass
    return templates.TemplateResponse("journal_analysis.html", {"request": request})